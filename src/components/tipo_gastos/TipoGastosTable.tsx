        ...
        <>
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-3 md:hidden">
                    {tipoGastos.map(tipo => (
                        <div key={tipo.id} className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-4">
                            ...
                            <div className="flex justify-end gap-3">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-1 text-red-600 hover:text-red-900 dark:text-red-400 text-sm"
                                >
