...
const inputStyles = "w-full text-gray-900 dark:text-gray-200 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-fuchsia-500 focus:border-fuchsia-500 transition-all dark:bg-gray-700 dark:border-gray-600";
...
export default function LiquidacionForm({ errors, register, getValues, unidades, operadores }: LiquidacionFormProps) {
    return (
        <div className="space-y-8">
            ...
            <fieldset className="p-4 border dark:border-gray-700 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5 mt-2">
                    ...
                    <FormField label="Kilómetros Recorridos" htmlFor="kilometros_recorridos" error={errors.kilometros_recorridos} required>
                        <input
                            id="kilometros_recorridos"
                            type="number"
                            className={inputStyles}
                            {...register("kilometros_recorridos", {
            ...
            {/* GRUPO 3: FECHAS */}
            <fieldset className="p-4 border dark:border-gray-700 rounded-lg">
                <legend className="px-2 text-base font-semibold text-gray-800 dark:text-gray-200">Fechas</legend>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-5 mt-2">
                    <FormField label="Fecha de Inicio" htmlFor="fecha_inicio" error={errors.fecha_inicio} required>
                        <input id="fecha_inicio" type="date" className={inputStyles}
                    ...
                    <FormField label="Fecha de Llegada" htmlFor="fecha_llegada" error={errors.fecha_llegada} required>
                        <input id="fecha_llegada" type="date" className={inputStyles}
                    ...
                    <FormField label="Fecha de Fin" htmlFor="fecha_fin" error={errors.fecha_fin} required>
                        <input id="fecha_fin" type="date" className={inputStyles}
                            {...register("fecha_fin", {
