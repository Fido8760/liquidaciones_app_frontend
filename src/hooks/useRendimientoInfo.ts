...
export const useRendimientoInfo = (liquidacion: Liquidacion) => {
    ...
    const porcentajeActual = Number(liquidacion.comision_porcentaje ?? porcentajeDefault);
    ...
    const rendimietoInfo = {
        ...
        mensaje: tieneAhorroDiesel ? 'El operador ahorró combustible' : 'El operador excedió el consumo esperado'
    };
